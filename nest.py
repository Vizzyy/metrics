...
def get_nest_data():
    ...
    for device in devices:
        ...
        traits = {
            ...
            'temperature_ambient_f': convert_to_f(device['traits']['sdm.devices.traits.Temperature']['ambientTemperatureCelsius']),
        ...
        for set_point in device['traits']['sdm.devices.traits.ThermostatTemperatureSetpoint'].keys():
            ...
            traits['temperature_set_point_f'] = convert_to_f(device['traits']['sdm.devices.traits.ThermostatTemperatureSetpoint'][set_point])
